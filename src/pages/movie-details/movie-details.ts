...
export class MovieDetailsPage {
	...
	getMovieVideos(): void {
		this.movieService.getVideos(this.selectedMovie.id).then(video => this.url = this.sanitizer.bypassSecurityTrustResourceUrl("https://www.youtube.com/embed/" + video.key + "?rel=0&amp;controls=0&amp;showinfo=0"));
